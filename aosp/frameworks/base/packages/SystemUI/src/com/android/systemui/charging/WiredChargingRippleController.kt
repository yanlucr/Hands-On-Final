...
class WiredChargingRippleController @Inject constructor(
    ...
    companion object {
        private const val TAG = "WiredChargingRippleControllerTAG"
    }
    ...
    init {
        ...
        updateRippleColor()
        Log.i(TAG, "Iniciei Ripple=$rippleEnabled, Plugado? =$pluggedIn")

        rippleView.updateBatteryLevel(currentBatteryLevel.toFloat())
    }
    ...
    fun registerCallbacks() {
        val batteryStateChangeCallback = object : BatteryController.BatteryStateChangeCallback {
            override fun onBatteryLevelChanged(
                ...
                Log.d(TAG, "Battery state mudou: level=$level, pluggedIn=$nowPluggedIn, charging=$charging")
                ...
                rippleView.updateBatteryLevel(level.toFloat())
                ...
                // parece q nao ta pegando direito essa onda
                if (pluggedIn) { rippleView.updateBatteryLevel(level.toFloat()) }
            }
        }
